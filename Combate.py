...
class Aplicação:
    ...
    def gerarTopListas(janela):
        ...
        janela.Preencher(janela.listaHerois, listaHerois)
        ...
        janela.updateHerois = Button(janela.frameHerois, text='Update', command=lambda Herois=AtualizarLista(
            arquivoHerois): janela.Preencher(janela.listaHerois, Herois))
        ...
        janela.Preencher(janela.listaCriaturas, listaCriaturas)
        ...
        janela.updateCriaturas = Button(janela.frameCriaturas, text='Update', command=lambda Criaturas=AtualizarLista(
            arquivoCriaturas): janela.Preencher(janela.listaCriaturas, Criaturas))
    ...
    def Preencher(janela, listbox, dados):
...
arquivoHerois = 'herois'
arquivoCriaturas = 'criaturas'
Herois = []
Criaturas = []

root = Tk()
Aplicação = Aplicação(root)
root.withdraw()
root.mainloop()
